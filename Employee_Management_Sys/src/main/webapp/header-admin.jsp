                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="updatesalary.jsp"><strong>Update Salary </strong></a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="approve-leave"><strong>Approve Leave</strong> </a>
                                </li>
                                <li class="nav-item">
