...
<body>
	...
	<c:forEach var="ele" items="${rs.rows}">
					...
					<tr>
                        ...
                        <form "><button type="button" class="btn btn-secondary"  disabled >${ele.status}</button></form>
                          </div></th>  
         
                          <th scope="row"><div class="btn-group" role="group" aria-label="Basic example">
                        <form action="confirming"><input type="submit" class="btn btn-info" onclick="this.value=${ele.eid}" value="Accept Request" name="str"></input></form>
                          </div></th>                
                    </tr>	
	</c:forEach>
